...
extension float4x4 {
    ...
    // MARK: - Left handed projection matrix - This fucked up the somethings
...
//    }
    ...
    // Taken from the warren math library & changed from rhs to lhs (Actually still trying to figure out lhs)
